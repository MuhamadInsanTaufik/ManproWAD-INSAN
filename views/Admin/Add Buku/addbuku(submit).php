    ...
    <section class="section dashboard">
        ...
        <div class="row align-items-start">
              ...
              <div class="card info-card sales-card">
                <div class="card-body">
                  <div class="detailbuku">
                    <p class="text-checklist1">Buku berhasil masuk ke database!</p>
                    <img src="..\..\..\assets\img\Checklist Symbol.png" class="img-checklist">
                    <p class="text-checklist2">Silahkan cek ke daftar buku</p>
                  </div>
                </div>
              </div><!-- End Sales Card -->
            <!-- Revenue Card -->
          ...
          <div class="col tambah">
            <span class="thx-menambahkan">
              <p class="thx">TERIMA KASIH TELAH <p class="thx menyumbang">MENAMBAHKAN BUKU!</p></p>
            </span>
          </div>
        </div>
    </section>
